...
export const toolsRegistry: ToolHubEntry[] = [
  ...
  },
  {
    ...
    description: 'QR codes with brand colours, rounded dots and a centered logo.',
    category: 'Barcode & QR',
    status: 'built',
    route: '/tools/qr-branded',
    keywords: ['branded qr', 'styled qr', 'logo qr', 'custom qr'],
  },
  {
    id: 'qr-bulk',
    name: 'Bulk QR Batch Export',
    description: 'Generate branded QR codes from a CSV and download them all as one ZIP.',
    category: 'Barcode & QR',
    status: 'built',
    route: '/tools/qr-bulk',
    keywords: ['bulk qr', 'batch qr', 'csv qr', 'qr zip'],
  },
  {
    id: 'sticker-sheet',
    name: 'Sticker Sheet Generator',
    description: 'Lay out repeated labels/stickers onto an A4/A3/SRA3 sheet — PNG or print PDF.',
    category: 'Packaging',
    status: 'built',
    route: '/tools/sticker-sheet',
    keywords: ['sticker sheet', 'label sheet', 'repeat label'],
  },
  {
    id: 'logo-export',
    name: 'Logo Export Package Builder',
    description: 'One coloured SVG → white/black/single/2-colour variants, tight-cropped, as SVG+PNG+JPG+PDF, size-capped, named, in one ZIP.',
    category: 'SVG & Vector',
    status: 'built',
    route: '/tools/logo-export',
    keywords: ['logo export', 'logo variants', 'white logo', 'black logo', 'brand assets'],
  },
  {
    id: 'illustrator-export',
    name: 'Illustrator: Export Artboard as JPG + PDF',
    description: 'Downloadable Illustrator script to export the active artboard as JPG + PDF in one go.',
    category: 'Document & Delivery',
    status: 'built',
    route: '/tools/illustrator-export',
    keywords: ['illustrator script', 'export artboard', 'jsx'],
  },
